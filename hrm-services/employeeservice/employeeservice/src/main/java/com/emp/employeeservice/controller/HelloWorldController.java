...
public class HelloWorldController {
	...
	public ResponseEntity<Employee> getUserDetails(@RequestHeader("username") String username) {
		Optional<Employee> tutorialData = employeerepository.findByUsername(username);
		if (tutorialData.isPresent()) {
